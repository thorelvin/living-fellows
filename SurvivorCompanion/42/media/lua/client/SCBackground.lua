...
local professions = {
    ...
    doctor = {
        ...
        downtime = { replace_bandage = 4, wash_self = 1, wash_equipment = 2, study_corpse = 4 },
    ...
    farmer = {
        ...
        jobs = { farm = 12, fetch = 4, haul = 4, maintain = 4 },
    ...
    nurse = {
        ...
        downtime = { replace_bandage = 5, wash_self = 1, wash_equipment = 2, study_corpse = 3 },
