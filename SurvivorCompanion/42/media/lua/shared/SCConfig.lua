...
local valueData = {
    ...
    -- Read-only CharacterStat probe for live 42.x verification. Reports one
    -- bounded vector per companion and never writes native or relationship state.
    vitalsStatTrace = false,
    vitalsStatTraceIntervalMs = 10000,
    vitalsStatTraceActorLimit = 32,
    ...
    perceptionAttackCommitRadius = 1.5,
    lastKnownThreatMs = 5000,
    heardThreatMemoryMs = 5000,
    zombieHearingIdleRadius = 2.25,
    zombieHearingMovingRadius = 6,
    zombieHearingAttackingRadius = 9,
    soundMemoryMs = 8000,
    soundLimit = 16,
    escapeScanRadius = 5,
    ...
    navigationFireEmergencyPenalty = 80,
    navigationExplosiveTrapEmergencyPenalty = 60,
    ...
    navigationRouteCrossTrackDistance = 0.75,
    navigationRouteInstabilityMs = 350,
    ...
    navigationPassageApproachRadius = 2.5,
    navigationPassageHeadLeaseMs = 1100,
    navigationPassageStallMs = 900,
    navigationPassageYieldMs = 500,
    ...
    formationRoleStableMs = 2000,
    formationVacancyGraceMs = 1000,
    ...
    -- Repeating Focus on the same target is a relationship-gated push. Social
    -- confidence may stretch, but never bypass, the ordinary overrun ceiling.
    combatRelationshipOverrunModifierCap = 4,
    combatPushOverrunModifierCap = 4,
    combatPushWindowMs = 4000,
    combatPushMoraleCost = 4,
    combatPushStressCost = 8,
    combatPushOutcomeWindowMs = 30000,
    combatPushInjuryHealthLoss = 5,
    combatMeleeCommitMs = 650,
    combatRangedCommitMs = 1000,
    combatMotionHistoryMs = 1500,
    combatMotionSampleMinimumMs = 80,
    combatMotionSampleMaximumMs = 750,
    combatMotionJumpDistance = 4,
    combatTimeToImpactWindowMs = 6000,
    combatTimeToImpactScore = 18,
    combatMeleeAnchorMs = 900,
    combatStompAnchorMs = 850,
    ...
    -- Interior-state dialogue reads engine stress/panic/nicotine values but is
    -- flavor only. These signals never enter the relationship stress meter.
    interiorStressRiseThreshold = 0.08,
    interiorPlayerStressRiseTolerance = 0.03,
    interiorPanicThreshold = 2,
    interiorNicotineThreshold = 0.12,
    interiorNicotineResetThreshold = 0.04,
    interiorActorCooldownMs = 180000,
    interiorPartyCooldownMs = 45000,
    interiorRefusalPriorityMs = 5000,
    interiorDreadChancePercent = 60,
    interiorPanicChancePercent = 100,
    interiorNicotineChancePercent = 65,
    interiorSpeechDistance = 10,
    ...
    lastWordsHealthThreshold = 15,
    lastWordsRecoveryThreshold = 35,
    lastWordsTurningThreshold = 97,
    lastWordsZombieMemoryMs = 12000,
    lastWordsPinnedCooldownMs = 30000,
    lastWordsFinalRepeatGuardMs = 6000,
    ...
    needsHungerSerious = 0.70,
    needsHungerEmergency = 0.82,
    needsThirstThreshold = 0.48,
    needsThirstSerious = 0.62,
    needsThirstEmergency = 0.75,
    needsFatigueThreshold = 0.50,
    needsFatigueSerious = 0.68,
    needsFatigueEmergency = 0.82,
    needsSpeechActorCooldownMs = 120000,
    needsSpeechQuietMs = 15000,
    ...
    farmSpeechGroupCooldownMs = 12000,
    farmDayStartHour = 6,
    farmDayEndHour = 21,
    ...
    factionQuestTargetMinDistance = 28,
    factionQuestTargetMaxDistance = 85,
    factionQuestHouseSampleBudget = 112,
    factionQuestHordeActivationRadius = 32,
    factionQuestHordeMinSize = 8,
    factionQuestHordeMaxSize = 14,
    factionQuestInventoryScanLimit = 4096,
