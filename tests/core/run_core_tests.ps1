...
try {
    ...
    try {
        ...
        Add-ScJvmStep 'farming-lifecycle' @('-cp', "$BuildRoot;$Jar", 'KahluaTestRunner') $farmingLifecycleFiles 'Farm ownership, recovery, and cancellation regression harness failed.'
